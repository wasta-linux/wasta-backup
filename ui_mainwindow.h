...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        backupButton->setGeometry(QRect(280, 110, 251, 41));
        ...
        cancelBackupButton->setGeometry(QRect(280, 160, 251, 27));
        ...
        prevItemLabel->setGeometry(QRect(0, 15, 141, 51));
        ...
        prevItem->setGeometry(QRect(150, 10, 371, 27));
        ...
        prevFileRadio->setGeometry(QRect(150, 40, 101, 22));
        ...
        prevFolderRadio->setGeometry(QRect(260, 40, 111, 22));
        ...
        restorePageWidget->setCurrentIndex(0);
